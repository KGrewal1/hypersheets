...
# %% auto 0
__all__ = ['FLATUI_COLORS', 'GRAYSCALE_COLORS', 'format_cur_axis', 'format_pct_axis', 'plot_returns_bars', 'plot_timeseries',
           'plot_histogram', 'plot_rolling_stats', 'plot_rolling_beta', 'plot_longest_drawdowns', 'plot_distribution',
           'plot_table']
