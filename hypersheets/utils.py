...
# %% auto 0
__all__ = ['mtd', 'qtd', 'ytd', 'pandas_date', 'pandas_current_month', 'multi_shift', 'to_excess_returns', 'prepare_returns',
           'to_returns', 'to_prices', 'to_log_returns', 'log_returns', 'exponential_stdev', 'download_prices',
           'download_returns', 'prepare_benchmark', 'rebase', 'group_returns', 'aggregate_returns', 'prepare_prices',
